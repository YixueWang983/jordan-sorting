...
\begin{tikzpicture}[font=\small,node distance=7mm and 9mm]
  \node[font=\small\bfseries] at (2.8,4.95) {(a) Pair-family containment};
  \node[box] (ud) at (1.35,4.15) {upper family\\dummy};
  \node[box] (p4) at (1.35,3.00) {$P_4=\{z_3,z_4\}$};
  \node[box] (p2) at (.35,1.82) {$P_2=\{z_1,z_2\}$};
  \node[box] (p6) at (2.35,1.82) {$P_6=\{z_5,z_6\}$};
  \draw[flow] (ud) -- (p4);
  \draw[flow] (p4) -- (p2);
  \draw[flow] (p4) -- (p6);

  \node[box] (ld) at (4.55,4.15) {lower family\\dummy};
  \node[box] (p3) at (3.55,3.00) {$P_3=\{z_2,z_3\}$};
  \node[box] (p7) at (4.85,3.00) {$P_7=\{z_6,z_7\}$};
  \node[box] (p5) at (5.85,1.82) {$P_5=\{z_4,z_5\}$};
  \draw[flow] (ld) -- (p3);
  \draw[flow] (ld) -- (p7);
  \draw[flow] (ld) -- (p5);
  ...
  \draw[flow] (beforeowner) -- node[above,font=\scriptsize] {owns} (beforelist);
  ...
  \draw[flow] (afterowner) -- node[above,font=\scriptsize] {owns} (afterlist);
  ...
  \draw[accent flow] (newowner) -- node[above,font=\scriptsize] {owns} (newlist);
  \node[font=\scriptsize,text=accent] at (10.38,-2.72) {ownership rebinding};

  \begin{scope}[on background layer]
    \draw[black!25,rounded corners=2pt] (-.35,1.05) rectangle (6.65,5.35);
