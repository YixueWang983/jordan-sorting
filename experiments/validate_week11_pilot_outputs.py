...
from experiment_validation_support import (  # noqa: E402
    expected_case_summaries as _expected_case_summaries,
    expected_group_summaries as _expected_group_summaries,
    matches_expected as _matches_expected,
    ...
    validate_case_metadata as _validate_case_metadata_shared,
    validate_schema as _validate_schema,
    validate_summary_rows as _validate_summary_rows,
)
...
def _validate_case_metadata(row, expected, label, errors):
    _validate_case_metadata_shared(
        row,
        expected,
        STRUCTURAL_FIELDS,
        label,
