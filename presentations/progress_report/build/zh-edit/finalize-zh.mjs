...
const candidatePath = path.join(
  workspaceDir,
  "presentations/progress_report/build/candidates/Jordan_Sorting_Progress_Report_ZH_midterm_candidate.pptx",
);
const finalPath = path.join(
  workspaceDir,
  "presentations/progress_report/build/final/Jordan_Sorting_Progress_Report_ZH_midterm_final.pptx",
);
...
const result = await finalizePresentation({
  ...
  receiptPath: path.join(
    workspaceDir,
    "presentations/progress_report/build/validation/Jordan_Sorting_Progress_Report_ZH_midterm_final.validation.json",
  ),
});
