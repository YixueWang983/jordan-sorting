...
through counterexamples, the related 1986 account, mirrored cases, and
repository validation. This supports a paper-facing reconstruction, but not a
...
timed paper call and does not make the core a recognition algorithm. Week~12
contains only oracle-certified valid-input sorting cases and explicitly
...
\section{Execution Environment and Cross-Week Replication}
\label{sec:limitations-execution}

% Method claim M-13, result claim R-11; limitation L-06
The absolute Week~12 runtimes come from one execution in the recorded Apple M4
environment running CPython 3.12.4. Warm-ups, repeated calls, randomized
