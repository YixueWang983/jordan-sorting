...
\begin{tikzpicture}[font=\small,node distance=8mm and 10mm]
  ...
  \node[box,minimum width=3.1cm,left=of oracle] (audit) {checked-state audit\\one per exact case};
  ...
  \node[box,minimum width=3.1cm,left=of manifest] (validate) {evidence-contract\\validation\\\scriptsize excluded from pipeline time};
  \node[accent box,minimum width=3.1cm,left=of validate] (archive) {archived,\\manifest-bound evidence};
