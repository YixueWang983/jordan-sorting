...
All 3600 measured rows in the frozen Week~12 run belong to 60 exact cases that
each passed one untimed checked audit before timing. Every row records an
...
pass. This is empirical correctness evidence for the frozen cases, not a proof
