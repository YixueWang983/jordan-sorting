...
const TALK = {
  ...
  14: `I compute the paper/reference ratio for each exact case, then take the median at each size with equal weight per case. The ratios are 3.226 at n equals 32, 2.202 at 64, 1.351 at 128, 0.851 at 256, and 0.567 at 512. Thus, the ratio is above one at 128 and below one at 256. Paper calls take less time at the two larger sizes under these scopes. Since the scopes differ, this does not establish an end-to-end speedup. Python sort has the lowest median call time at every tested size, as shown in Backup A.`,
